           ...
           <div className='mx-[5%] py-20'>
                ...
                <div className="hidden md:flex">
                    <div className="md:w-1/3 p-3 flex-col">
                        <img src={Painting6} alt="bathroom" className='' width={'100%'} style={{borderRadius:'7px',height:'90%'}} /> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                        <img src={Painting2} alt="bathroom" width={'100%'} style={{borderRadius:'7px',height:'90%'}}/> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                    <img src={Painting7} alt="bathroom" width={'100%'} style={{borderRadius:'7px',height:'90%'}} /> 
                    </div>
                </div>
