    ...
    <>
        ...
        <section className='relative text-black'>
           <div className='mx-[5%] py-20'>
                <h1 className='text-center font-bold text-2xl pb-5'>KITCHEN GALLERY</h1>
                <div className="hidden md:flex">
                    <div className="md:w-1/3 p-3 flex-col">
                        <img src={Kitchen1} alt="bathroom" className='' width={'100%'} style={{borderRadius:'7px'}} /> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                        <img src={Kitchen2} alt="bathroom" width={'100%'} style={{borderRadius:'7px',}}/> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                    <img src={Kitchen3} alt="bathroom" width={'100%'} style={{borderRadius:'7px'}} /> 
                    </div>
                </div>
                <div className="md:flex">
                    <div className="md:w-1/3 p-3 flex-col">
                        <img src={Kitchen4} alt="bathroom" className='' width={'100%'} style={{borderRadius:'7px',height:'340px'}} /> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                        <img src={Kitchen8} alt="bathroom" width={'100%'} style={{borderRadius:'7px',height:'340px'}}/> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                    <img src={Kitchen6} alt="bathroom" width={'100%'} style={{borderRadius:'7px',height:'340px'}} /> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                    <img src={Kitchen7} alt="bathroom" width={'100%'} style={{borderRadius:'7px',height:'340px'}} /> 
                    </div>
                    <div className="md:w-1/3 p-3 flex-col">
                    <img src={Kitchen5} alt="bathroom" width={'100%'} style={{borderRadius:'7px',height:'340px'}} /> 
                    </div>
                </div>
