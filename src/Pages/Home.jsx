                ...
                <div className='relative '>
                    <div className="md:flex container px-5 gap-3 pb-20">
                        <div className="md:w-1/2 img-shadow2 mt-28  flex-col">
                            ...
                            className='  md:flex mb-7  lg:mr-[-300px] text-4xl font-bold text-color2 lg:text-start md:text-center'>BUILDING YOUR VISION RECREATING YOUR IMAGINATION 
                            </motion.h3>
                            ...
                            className='mt-32 md:mt-10 lg:mt-10 md:text-center lg:text-start pr-10 hidden md:flex-col md:flex text-color2 ' style={{fontFamily: 'Poppins, sans-serif'}}>Work with us to make imagination a reality. Create that dream space you have always wanted. Our team will work with you to achieve your perfect space! 
